...
export const BOOKS = {
  "book_list": [
    ...
    {
      "b_desc": "Cuốn Từ Điển Anh-Việt 350.000 Từ này được biên soạn theo Cambridge Dictionary: - Cập nhật hơn 350.000 từ mới thuộc các lĩnh vực - Giải nghĩa đầy đủ, ví dụ phong phú - Trình bày ngắn gọn, khoa học, dễ sử dụng - Đáp ứng yêu cầu học tập, tra cứu, dịch thuậ Giá sản phẩm trên Tiki đã bao gồm thuế theo luật hiện hành. Bên cạnh đó, tuỳ vào loại sản phẩm, hình thức và địa chỉ giao hàng mà có thể phát sinh thêm chi phí khác như phí vận chuyển, phụ phí hàng cồng kềnh, thuế nhập khẩu (đối với đơn hàng giao từ nước ngoài có giá trị trên 1 triệu đồng).....",
      "b_edition": "2016",
      "b_hot": false,
      "b_id": "9",
      "b_img": "https://storage.googleapis.com/ecommerce-22057.appspot.com/ARC9.jpg",
