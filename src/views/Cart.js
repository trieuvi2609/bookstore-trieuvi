...
export default function Cart() {
    ...
    const countTotal = (cartItems) => {
        return cartItems.reduce((prev, current) => { return (prev + current.item.price * current.number) }, 0);
    }
    return (
        <div>
            <Navbar attr="fixed" />
                ...
                <section className="bg-blueGray-200 pt-20">
                    <div className="container mx-auto px-10 py-10">
                        <div className="flex flex-wrap">
                            <div className="lg:pt-6 pt-6 w-full md:w-8/12 px-4 text-center shadow-lg rounded-lg bg-white">
                                    ...
                                    <div className="px-2 py-5 flex-auto">
                                        <div className="py-3">
                                            ...
                                            <h1 className="text-blueGray-500 text-xl font-bold py-2">
                                                {(countTotal(cartItems) * 1000).toLocaleString('it-IT', { style: 'currency', currency: 'VND' })}
                                            </h1>
                                            <div className="flex flex-wrap">
                                                <button className="bg-lightBlue-500 text-white active:bg-lightBlue-600 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow-lg outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150 w-full " type="button">
                                                    Make your payment
                                                </button></div>
                                        </div>
                                    </div>
