...
export default function Register() {
            ...
            <div className="bg-white shadow-lg rounded-lg text-center border-1">
              <div className="px-2">
                <div className="px-3 py-3">
                  ...
                  <p className="mx-10">Please fill the otp send to your phone here</p>
                  <div className="md:px-10 py-4"><InputOtp onChange={handleChangeOtp} value={otp} /></div>
                  <div className="flex flex-row justify-between px-10 py-2">
                    <button className="bg-blueGray-600 text-white active:bg-lightBlue-600 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow-lg outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150" onClick={()=>{resendOTP();}}>Resend</button>
                    <button className="bg-blueGray-600 text-white active:bg-lightBlue-600 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow-lg outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150"
                      onClick={() => {
                        dispatch(signUp({ username: userName, fullName: name, password: password, email: email, contact: phone }));
                        history.push("/home");
                        onClose();
                      }}
                    >
  ...
  const responseGoogle = (response) => {
    ...
    dispatch(signUp({ fullName: googleName, username: googleEmail, email: googleEmail, imageUrl: imageUrl }));
    history.push("/home")
  }
  return (
    <>
