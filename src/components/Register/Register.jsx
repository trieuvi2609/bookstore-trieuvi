      ...
      <section className="relative w-full h-full py-10 min-h-screen">
        ...
        >
          ...
          <Modal.Body style={{
            ...
            <div className="px-3 py-3">
              ...
              <div className="md:px-10 py-4"><InputOtp onChange={handleChangeOtp} value={otp} errorMessage={'Your otp code is wrong'} error={errorOtp} /></div>
          ...
          <Modal.Footer style={{
            ...
            <button className="bg-lightBlue-500 text-white active:bg-blueGray-600 text-xs font-bold uppercase px-4 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150" onClick={() => { resendOTP(); }}>Resend</button>
            <button className="bg-lightBlue-500 text-white active:bg-blueGray-600 text-xs font-bold uppercase px-4 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150" disabled={disable}
              onClick={async () => {
                if (sendOTP === otp) {
                  setDisable(true);
        ...
        >
          <Modal.Body style={{
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="h-16 text-center text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <div className="text-center"><p>You have registered successfully!</p><p> Please log in again with your new account</p></div>
          ...
          <Modal.Footer style={{
            ...
            <button className="bg-lightBlue-500 text-white active:bg-blueGray-600 text-xs font-bold uppercase px-3 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150" onClick={handleClose2}>Close</button>
                  ...
                  <form>
                    <div className="relative w-full mb-3">
                      ...
                      <div className="relative w-full pt-2">
                        <h1
                          className={"block text-blueGray-500 text-xs mb-2 "}
                        >
                          5 to 16 characters in length, no special characters
                        </h1>
                        <h1
                          className={"block text-red-500 font-bold text-xs mb-2 " + userNameHidden}
                        >
                          {userNameError}
                        </h1>
                      </div>
                    ...
                    <div className="relative w-full mb-3 pb-6 border-b-2">
                      ...
                      <div className="relative">
                        ...
                        <div className="absolute right-0 top-0 pr-3 pt-3 text-blueGray-300">
                          {!showPassword ? <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" onClick={handleClickShowPassword}>
                            <path fillRule="evenodd" d="M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414l-1.473-1.473A10.014 10.014 0 0019.542 10C18.268 5.943 14.478 3 10 3a9.958 9.958 0 00-4.512 1.074l-1.78-1.781zm4.261 4.26l1.514 1.515a2.003 2.003 0 012.45 2.45l1.514 1.514a4 4 0 00-5.478-5.478z" clipRule="evenodd" />
                            <path d="M12.454 16.697L9.75 13.992a4 4 0 01-3.742-3.741L2.335 6.578A9.98 9.98 0 00.458 10c1.274 4.057 5.065 7 9.542 7 .847 0 1.669-.105 2.454-.303z" />
                          </svg> : <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" onClick={handleClickShowPassword}>
                      ...
                      <div className="relative w-full mb-3 pt-2">
                        ...
                        <h1
                          className={"block text-red-500 font-bold text-xs mb-2 " + passwordHidden}
                        >
                          {passwordError}
                        </h1>
                      </div>
                    ...
                    <div className="relative w-full mb-3">
                      ...
                      <div className="relative w-full mb-3 pt-2">
                        <h1
                          className={"block text-red-500 font-bold text-xs mb-2 " + nameHidden}
                        >
                          {nameError}
                        </h1>
                      </div>
                    ...
                    <div className="relative w-full mb-3">
                      ...
                      <div className="relative w-full mb-3 pt-2">
                        <h1
                          className={"block text-red-500 font-bold text-xs mb-2 " + emailHidden}
                        >
                          {emailError}
                        </h1>
                      </div>
                    ...
                    <div className="relative w-full mb-3">
                      ...
                      <div className="relative w-full mb-3 pt-2">
                        <h1
                          className={"block text-red-500 font-bold text-xs mb-2 " + phoneHidden}
                        >
                          {phoneError}
                        </h1>
                      </div>
