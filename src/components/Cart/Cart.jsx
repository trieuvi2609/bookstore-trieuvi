...
export default function Cart() {
  ...
  return (
    <div>
      <main>
        <section className="bg-blueGray-200 pt-20" style={{
          backgroundImage:
          ...
          <div className="container mx-auto px-10 py-10">
            ...
            <p className="cart__price-price">Price: {price.toLocaleString('it-IT', { style: 'currency', currency: 'VND' })}</p>
            <p className="cart__price-discount">Discount: {discount.toLocaleString('it-IT', { style: 'currency', currency: 'VND' })} </p>
            <hr />
            <p className="cart__price-cost">Total: {(price - discount).toLocaleString('it-IT', { style: 'currency', currency: 'VND' })}</p>
